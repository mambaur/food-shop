	...
	<div class="row">
		<div class="col-sm-4 col-sm-offset-1" style="background-color: white;padding:20px;">
			...
			<form action="<?php echo base_url('Owner_controller/O_produk/insert_produk'); ?>" id="main-contact-form" class="contact-form row" name="contact-form" method="post" enctype="multipart/form-data">
				...
				<div class="form-group col-md-12">
					Tanggal produksi:
					<input type="date" name="tanggal" class="form-control" required="required" placeholder="Tanggal produksi">
				</div>
				...
				<div class="form-group col-md-12">
					Stok produk:
					<input type="number" name="stok" min="1" class="form-control" required="required" placeholder="Stok produk">
				</div> 
				<div class="form-group col-md-12">
					Harga produk:
					<input type="number" name="harga" min="1" class="form-control" required="required" placeholder="Harga produk">
				</div>
        <div class="form-group col-md-12">
          Berat produk (gram):
