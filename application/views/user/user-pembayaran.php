...
<div class="container">
	<div class="row">
		<div class="col-sm-4 col-sm-offset-1">
			...
			<form action="<?php echo base_url('user/pembayaran/insert'); ?>" id="main-contact-form" class="contact-form row" name="contact-form" method="post" enctype="multipart/form-data">
		...
		<div class="col-sm-6">
			<h2 style="text-align: center;color: #FE980F;">Apa itu bukti pembayaran??</h2>
